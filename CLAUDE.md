...
Clawake is **free and open source (MIT)**. Distribution is a notarized Developer ID
DMG on GitHub Releases (see the distribution section below). There is no paid tier,
trial, or licensing code.
